...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.didSelectedIndex = ^(NSInteger index){
        NSString *platformName = [weakSelf.platformArray objectAtIndex:indexPath.row] ;
        [[UMComLoginManager getLoginHandler] didSelectPlatform:platformName feed:weakSelf.feed viewController:weakSelf.shareViewController];
        [weakSelf dismiss];
