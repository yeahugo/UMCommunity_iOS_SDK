...
- (id)initWithColor:(UIColor *)color
{
    ...
    if(self)
    {
        ...
        self.progressColor = [UIColor colorWithCGColor:CGColorCreateCopyWithAlpha(color.CGColor, 1)];
        self.backgroundColor = [UIColor colorWithCGColor:CGColorCreateCopyWithAlpha(color.CGColor, 0.1)];
        self.textColor = [UIColor colorWithCGColor:CGColorCreateCopyWithAlpha(color.CGColor, 1)];
    }
