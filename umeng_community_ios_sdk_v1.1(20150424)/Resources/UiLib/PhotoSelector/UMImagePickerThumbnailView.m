...
@interface UMImagePickerThumbnailView()
...
//    NSInteger length = MIN(3, assetsGroup.numberOfAssets);
    NSIndexSet *indexes = [NSIndexSet indexSetWithIndexesInRange:NSMakeRange(assetsGroup.numberOfAssets - 1, 1)];
