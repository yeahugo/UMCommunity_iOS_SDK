...
- (NSArray *)styleViewListWithNotifications:(NSArray *)notifications
{
    ...
    for (UMComNotification *notification in notifications) {
        UMComMutiText *styleView = [UMComMutiText mutiTextWithSize:CGSizeMake(self.tableView.frame.size.width-CellSubViewOriginX-CellSubViewRightSpace, MAXFLOAT) font:UMComFontNotoSansLightWithSafeSize(15) string:notification.content lineSpace:2 checkWords:nil];
