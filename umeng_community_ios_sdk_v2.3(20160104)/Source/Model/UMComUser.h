...
@property (nonatomic, retain) NSNumber * atype;//0表示普通用户；1表示全局管理员；2暂时没用；3创建社区时的默认管理员；4.话题管理员。
...
@property (nonatomic, retain) NSNumber * has_followed;//是否已经关注
@property (nonatomic, retain) NSNumber * be_followed;//是否关注我
