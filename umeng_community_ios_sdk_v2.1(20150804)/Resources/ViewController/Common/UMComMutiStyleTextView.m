...
//    [attributedString addAttribute:(NSString *)kCTForegroundColorAttributeName value:(id)self.textColor.CGColor range:range];
    CTFontRef FontRef = CTFontCreateFromUIFont(self.font);
    [attributedString addAttributes:@{NSFontAttributeName:(__bridge id)FontRef,NSForegroundColorAttributeName:self.textColor,UMComContentKey:[NSNumber numberWithInt:UMComContentTypeFriend]} range:range];
}
...
//    [attributedString addAttribute:(NSString *)kCTForegroundColorAttributeName value:(id)self.textColor.CGColor range:range];
    CTFontRef FontRef = CTFontCreateFromUIFont(self.font);
    [attributedString addAttributes:@{NSFontAttributeName:(__bridge id)FontRef,NSForegroundColorAttributeName:self.textColor,UMComContentKey:[NSNumber numberWithInt:UMComContentTypeNormal]} range:range];
}
