...
{
    if ([[UMComSession sharedInstance].unReadMessageDictionary valueForKey:@"notice"] && [[[UMComSession sharedInstance].unReadMessageDictionary valueForKey:@"notice"] integerValue] > 0) {
...
{
    UMComFeedTableViewController *collectionViewController = [[UMComFeedTableViewController alloc] init];
    collectionViewController.fetchFeedsController = [[UMComUserFavouritesRequest alloc]initWithUid:[UMComSession sharedInstance].uid count:TotalCollectionsSize];
