...
//获取用户的被喜欢feed
- (id)initWithCount:(NSInteger)count uid:(NSString *)uid response:(LoadDataCompletion)response;
@end
...
//获取消息对应的所有评论
- (id)initWithFeedId:(NSString *)feedId order:(NSString *)order response:(PageDataResponse)response;
