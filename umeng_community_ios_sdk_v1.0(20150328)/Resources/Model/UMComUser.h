...
@class UMComComment, UMComFeed, UMComLike, UMComLoginUser, UMComTopic, UMComUser, UMComUserProfile;
...
@property (nonatomic, retain) UMComLoginUser *login_user;
...
@property (nonatomic, retain) UMComUserProfile *user_profile;
@end
