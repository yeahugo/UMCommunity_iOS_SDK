...
//        UMLog(@"%@___%@",self.topic.name,self.topic.is_focused);
...
{
//    [self setFocused:![weakSelf.topic.is_focused boolValue]];/
...
//        if (!error) {
//            [weakSelf setFocused:[weakSelf.topic.is_focused boolValue]];
//        } else {
//            [UMComShowToast fetchFeedFail:error];
//        }
    }];
