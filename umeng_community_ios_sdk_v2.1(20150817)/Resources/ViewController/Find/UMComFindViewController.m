...
{
    UMComFavouratesTableView * favouratesTableView = [[UMComFavouratesTableView alloc] initWithFrame:CGRectMake(0, -kUMComRefreshOffsetHeight, self.view.frame.size.width, self.view.frame.size.height + kUMComRefreshOffsetHeight)];
    UMComFavouratesViewController *collectionViewController = [[UMComFavouratesViewController alloc] initWithFeedsTableView:favouratesTableView];
    collectionViewController.fetchFeedsController = [[UMComUserFavouritesRequest alloc] init];
    collectionViewController.title = UMComLocalizedString(@"user_collection", @"我的收藏");
