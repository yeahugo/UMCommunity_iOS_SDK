...
- (void)viewDidLoad
{
    [super viewDidLoad];
//    
    UIView *footView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.tableView.frame.size.width, BottomLineHeight)];
    if ([[[UIDevice currentDevice] systemVersion]floatValue] < 8.0) {
        footView.backgroundColor = TableViewSeparatorRGBColor;
    }else{
