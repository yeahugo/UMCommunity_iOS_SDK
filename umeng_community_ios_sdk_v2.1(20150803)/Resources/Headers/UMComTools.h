...
#define FeedDeletedFinish @"feedDeletedFinish"
#define CommentOperationFinish @"commentOperationFinish"
#define LikeOperationFinish @"likeOperationFinish"

extern CGFloat const kUMComRefreshOffsetHeight;
