...
//    feedStyle.likeCount = [feed.likes_count intValue];
//    feedStyle.commentsCount = [feed.comments_count intValue];
//    feedStyle.forwordCount = 0;
//    feedStyle.subViewWidth = viewWidth - feedStyle.subViewDeltalWidth;
//    
...
//        }
//        UMComMutiStyleTextView *feedStyleView = [UMComMutiStyleTextView rectDictionaryWithSize:CGSizeMake(feedStyle.subViewWidth, MAXFLOAT) font:FeedFont attString:feedSting lineSpace:TextViewLineSpace runType:UMComMutiTextRunFeedContentType clickArray:[NSMutableArray arrayWithObject:feedClickTextDict]];
//
...
//            feedStyle.location = origin_feed.location;
//        }
...
//        
//        UMComMutiStyleTextView *originStyleView = [UMComMutiStyleTextView rectDictionaryWithSize:CGSizeMake(feedStyle.subViewWidth-FeedAndOriginFeedDeltaWidth, MAXFLOAT) font:FeedFont attString:oringFeedString lineSpace:TextViewLineSpace runType:UMComMutiTextRunFeedContentType clickArray:[NSMutableArray arrayWithObject:originFeedClickTextDict]];
//        originStyleView.totalHeight += OriginFeedHeightOffset;
//        totalHeight += originStyleView.totalHeight + OriginFeedOriginY;
//        originStyleView.frame = CGRectMake(0, 0, feedStyle.subViewWidth-FeedAndOriginFeedDeltaWidth, originStyleView.totalHeight);
//        feedStyle.originFeedStyleView = originStyleView;
//    }else{
//        if (feed.location) {
//            feedStyle.location = feed.location;
//        }
//    }
//    if (feedStyle.location) {
//        totalHeight += LocationBackgroundViewHeight + 3;
//    }
//    feedStyle.images = feed.images;
//    feedStyle.imageGridViewOriginX = 0;
//    if (origin_feed && !origin_feed.isDeleted) {
//        feedStyle.images = origin_feed.images;
//        feedStyle.imageGridViewOriginX = FeedAndOriginFeedDeltaWidth/2;
//    }
//    if(feedStyle.images.count > 0) {
//        CGFloat imagesViewHeight = (feedStyle.subViewWidth- feedStyle.imageGridViewOriginX*2-ImageSpace*2)/3;
//        feedStyle.imagesViewHeight = imagesViewHeight+feedStyle.imageGridViewOriginX;
//        if (feedStyle.images.count > 3) {
//            feedStyle.imagesViewHeight += (imagesViewHeight + ImageSpace);
//            if (feedStyle.images.count > 6) {
//                feedStyle.imagesViewHeight += (imagesViewHeight + ImageSpace);
//            }
//        }
//        totalHeight += feedStyle.imagesViewHeight+DeltaHeight;
//    }else{
//    
//    }
//    totalHeight += 45;
//    feedStyle.totalHeight = totalHeight;
//    feedStyle.dateString = createTimeString(feed.create_time);
