...
@interface UMComLikeUserViewController ()
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row > 0) {
        UMComUser *user = self.likeUserList[indexPath.row-1];
        [[UMComUserCenterAction action] performActionAfterLogin:user viewController:self completion:^(NSArray *data, NSError *error) {
