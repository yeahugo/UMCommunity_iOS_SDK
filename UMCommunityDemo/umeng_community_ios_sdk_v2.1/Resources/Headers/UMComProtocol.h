...
#define UserSpamPath @"spamer/user"
...
#define UserUnreadMessageCount  @"notification/message_box"//@"user/messages_count"
#define UserNotification        @"notification/notices"//@"notification/message_box"
